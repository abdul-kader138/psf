...
$(document).ready(function () {
    ...
    // a.kader
    $('body').on('click', '.analysis_link td:not(:first-child, :nth-child(2), :last-child)', function () {
        $('#myModal').modal({remote: site.base_url + 'farmer_analysis/modal_view/' + $(this).parent('.analysis_link').attr('id')});
        $('#myModal').modal('show');
    });
...
$(document).ready(function () {
    ...
    $(document).on('click', '.row_approve_status', function (e) {
        e.preventDefault;
        var id = $(this).attr('id');
        $('#myModal').modal({remote: site.base_url + 'farmer_analysis/update_status/' + id});
        $('#myModal').modal('show');
        return false;
    });
