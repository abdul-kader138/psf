    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("sales_target/zone_add", $attrib);
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="well well-sm">
                            <a href="<?php echo $this->config->base_url(); ?>assets/csv/sample_zone_target.csv"
                            ...
                            <?php echo $this->lang->line("csv2"); ?> <span
                                class="text-info">( <?= lang("Zone_Code") . ', '. lang("Target_Quantity"); ?>
