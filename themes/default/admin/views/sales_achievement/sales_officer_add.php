...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('Sales_Officer_Info_Upload'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("sales_achievement/sales_officer_add", $attrib);
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="well well-sm">
                            <a href="<?php echo $this->config->base_url(); ?>assets/csv/sample_sales_officer_achv.csv"
                            ...
                            <?php echo $this->lang->line("csv2"); ?> <span
                                class="text-info">( <?= lang("Employee_Code") . ', '. lang("Sale_Quantity"). ', '. lang("No_Of_Visit"). ', '. lang("Sales_Amount"). ', '. lang("Credit_Amount"); ?>
