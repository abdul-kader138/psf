                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td class="col-sm-2"
                                    style="vertical-align:middle;">  <?= $row->username; ?></td>
                                <td class="col-sm-4"
                                    style="vertical-align:middle;">  <?= $row->first_name . " " . $row->last_name; ?></td>
                                <td class="col-sm-1" style="vertical-align:middle;">  <?= $row->zname; ?></td>
                                <td class="col-sm-1"
                                    style="vertical-align:middle;text-align: center">   <?= $row->um; ?></td>
                                <td class="col-sm-2"
                                    style="vertical-align:middle;text-align: center">   <?= $row->quantity; ?></td>
                                <td class="col-sm-2"
                                    style="vertical-align:middle;text-align: center">   <?= $row->credit_amount; ?></td>
                                <td class="col-sm-1"
                                    style="vertical-align:middle;text-align: center">   <?= $row->dealer; ?></td>
                                <td class="col-sm-1"
                                    style="vertical-align:middle;text-align: center">   <?= $row->no_of_visit; ?></td>
                            </tr>
                            <?php
                            $total = $total + $row->quantity;
                            $totalc = $totalc + $row->credit_amount;
                        ...
                        <tr>
                            <td colspan="<?= $col; ?>"
                                style="text-align:right; font-weight:bold;"><?= lang("Total_Credit_Amount"); ?>
                            </td>
                            <td style="text-align:right; padding-right:10px; font-weight:bold;">
                                <?= $this->sma->formatMoney($totalc); ?>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="<?= $col; ?>"
