...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('Zone_Target_Upload'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("competitor_analysis/zone_add_sales", $attrib);
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('category_id', $b2, (isset($_POST['category_id']) ? $_POST['category_id'] : ''), ' data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("Zone_Name") . '" required="required" id="category_id" class="form-control input-tip select" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                foreach ($units as $unit) {
                                    $b3[$unit->name] = $unit->name;
                                }
                                echo form_dropdown('um', $b3, (isset($_POST['um']) ? $_POST['um'] : ''), ' data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("UM") . '" required="required" id="um" class="form-control input-tip select" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="well well-sm">
                            <a href="<?php echo $this->config->base_url(); ?>assets/csv/sample_competitor_analysis_zone.csv"
                            ...
                            <?php echo $this->lang->line("csv2"); ?> <span
                                class="text-info">( <?= lang("Company") . ', '.lang("Zone_Code") . ', '. lang("Quantity"); ?>
