            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group company">
                        ...
                        <?php echo form_input('company', 'iFIX NYC | Broadway', 'class="form-control tip" id="company" data-bv-notempty="true" readonly'); ?>
                    </div>
                    ...
                    <div class="form-group">
                        <?= lang("vat_no", "vat_no"); ?>
                        <?php echo form_input('vat_no', '', 'class="form-control" id="vat_no" readonly'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("gst_no", "gst_no"); ?>
                        <?php echo form_input('gst_no', '', 'class="form-control" id="gst_no" readonly'); ?>
                    </div>
                    <!--<div class="form-group company">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('country', '', 'class="form-control" id="country" readonly'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("ccf1", "cf1"); ?>
                        <?php echo form_input('cf1', '', 'class="form-control" id="cf1" readonly'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("ccf2", "cf2"); ?>
                        <?php echo form_input('cf2', '', 'class="form-control" id="cf2" readonly'); ?>

                    </div>
                    <div class="form-group">
                        <?= lang("ccf3", "cf3"); ?>
                        <?php echo form_input('cf3', '', 'class="form-control" id="cf3" readonly'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("ccf4", "cf4"); ?>
                        <?php echo form_input('cf4', '', 'class="form-control" id="cf4" readonly'); ?>

                    </div>
                    <div class="form-group">
                        <?= lang("ccf5", "cf5"); ?>
                        <?php echo form_input('cf5', '', 'class="form-control" id="cf5" readonly'); ?>

                    </div>
                    <div class="form-group">
                        <?= lang("ccf6", "cf6"); ?>
                        <?php echo form_input('cf6', '', 'class="form-control" id="cf6"  readonly'); ?>
                    </div>
                </div>
            </div>
