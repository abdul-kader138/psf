...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#EXPData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('purchases/getDepotSales'); ?>',
...
<?php if ($Owner) {
    echo admin_form_open('purchases/sales_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-dollar"></i><?= lang('Sales'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('purchases/add_sales') ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus-circle"></i> <?= lang('Add_Sales') ?>
                            </a>
                        </li>
                        <li>
