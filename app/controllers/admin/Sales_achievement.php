...
class Sales_achievement extends MY_Controller
{
    ...
    function getSalesOfficer()
    {
        ...
        $this->datatables
            ->select($this->db->dbprefix('sales_officer_achievement') . ".reference_no as id, " . $this->db->dbprefix('sales_officer_achievement') . ".business_unit," . $this->db->dbprefix('categories') . ".name as c_name," . $this->db->dbprefix('zones') . ".name as zname,sum(" . $this->db->dbprefix('sales_officer_achievement') . ".dealer) as dealers,round(sum(" . $this->db->dbprefix('sales_officer_achievement') . ".quantity)/1000,2) as u_amount,round(sum(" . $this->db->dbprefix('sales_officer_achievement') . ".credit_amount),2) as c_amount," . $this->db->dbprefix('sales_officer_achievement') . ".month," . $this->db->dbprefix('sales_officer_achievement') . ".year")
